    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
          ...
          <!-- <button class="btn btn-primary modal-show" type="button" href="{{ route('history.create') }}" name="Tambah Produk Baru" data-toggle="modal" data-target="#modal">+ Add New</button> -->
        </div>
  ...
  <script>
    $('#table').DataTable({
      ...
      columns: [
        ...
        {title: 'Voucher', data: 'vouchers.name', name: 'vouchers.name', width: '30%', className: 'dt-head-center'},
        {title: 'Total', data: 'total', name: 'total', width: '30%', className: 'dt-head-center'},
        {title: 'Invoice', data: 'invoice', name: 'invoice', width: '30%', className: 'dt-head-center'},
        {title: 'Tanggal Invoice', data: 'date_invoice', name: 'date_invoice', width: '30%', className: 'dt-head-center'},
