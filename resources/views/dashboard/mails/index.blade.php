    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
          <h6 class="card-title mb-0">Mails</h6>
          <button class="btn btn-primary modal-show" type="button" href="{{ route('mail.create') }}" name="Masukan Isi Tawaran" data-toggle="modal" data-target="#modal">Kirim Tawaran</button>
        </div>
    ...
    $('body').on('click', '.modal-show', function(event){
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $('#modal-save').text(me.hasClass('edit') ? 'Update' : 'Kirim');
        }
      });
    });
