    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
          <h6 class="card-title mb-0">Mail Sent</h6>
          <!-- <button class="btn btn-primary modal-show" type="button" href="{{ route('mailhistory.create') }}" name="Tambah Produk Baru" data-toggle="modal" data-target="#modal">+ Add New</button> -->
        </div>
...
@push('js')
  <script>
    $('#table').DataTable({
      responsive: true,
      serverSide: true,
      ajax: "{{ route('mailhistory.data') }}",
      order: [[ 1, "asc" ]],
      columns: [
        {title: '#', data: 'DT_RowIndex', name: 'DT_RowIndex', orderable:false, width: '7.5%', className: 'dt-center'},
        {title: 'Subject', data: 'subject', name: 'subject', width: '30%', className: 'dt-head-center'},
        {title: 'Target', data: 'target', name: 'target', width: '30%', className: 'dt-head-center'},
        {title: 'Content', data: 'content', name: 'content', width: '30%', className: 'dt-head-center'},
