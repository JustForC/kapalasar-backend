...
@push('js')
  ...
  <script>
    $('#table').DataTable({
      ...
      order: [[ 0, "asc" ]],
      columns: [
        {title: '#', data: 'id', name: 'id', orderable:false, width: '7.5%', className: 'dt-center'},
        {title: 'Nama', data: 'name', name: 'name', width: '30%', className: 'dt-head-center'},
        {title: 'Produk', data: 'product', name: 'product', width: '30%', className: 'dt-head-center'},
        {title: 'Opsi', data: 'action', name: 'action', width: '12.5%', className: 'dt-center'},
      ],
    });
