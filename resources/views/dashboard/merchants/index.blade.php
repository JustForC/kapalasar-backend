    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
          <h6 class="card-title mb-0">Merchant</h6>
          <button class="btn btn-primary modal-show" type="button" href="{{ route('merchant.create') }}" name="Tambah Merchant" data-toggle="modal" data-target="#modal">+ Add New</button>
        </div>
  ...
  <script>
    $('#table').DataTable({
      ...
      columns: [
        ...
        {title: 'Address', data: 'address', name: 'address', className: 'dt-head-center'},
        {title: 'Phone', data: 'phone', name: 'phone', className: 'dt-head-center'},
        {title: 'Kode', data: 'referral_code', name: 'referral_code', className: 'dt-head-center'},
        {title: 'Umur', data: 'age', name: 'age', className: 'dt-head-center'},
        {title: 'Jenis Usaha', data: 'job', name: 'job', className: 'dt-head-center'},
        {title: 'Email', data: 'email', name: 'email', className: 'dt-head-center'},
