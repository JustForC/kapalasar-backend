  ...
  <script>
    $('#table').DataTable({
      ...
      columns: [
        ...
        {title: 'Address Detail', data: 'address_detail', name: 'address_detail', width: '30%', className: 'dt-head-center'},
        {title: 'Phone', data: 'phone', name: 'phone', width: '30%', className: 'dt-head-center'},
        {title: 'Kode', data: 'referral_code', name: 'referral_code', width: '30%', className: 'dt-head-center'},
        {title: 'Umur', data: 'age', name: 'age', width: '30%', className: 'dt-head-center'},
        {title: 'Jenis Usaha', data: 'job', name: 'job', width: '30%', className: 'dt-head-center'},
