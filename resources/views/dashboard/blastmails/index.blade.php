    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-4 mb-md-3">
          <h6 class="card-title mb-0">Kirim Email Ke Seluruh User</h6>
        </div>
<!--  -->
<form id="form_modal" class="form" method="POST" action="{{route('blastmail.send')}}" enctype="multipart/form-data">
    @csrf
